            ...
            <div className="max-w-[750px]">
                <div className="flex flex-col items-start gap-4 w-full">
                    ...
                    <div class="button-container">
                        ...
                        <a
                            className={`md:hidden inline-flex px-10 py-4 justify-center items-center gap-4 bg-[#2B2B2B] text-white hover:bg-[#353535] font-black md:text-2xl sm:text-base rounded-md`}
                            href={"https://aclucrossword.org/"}
                        >

                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="#FFFFFF" className="w-6 h-6">
...
const NavLink = () => {
    return (
        <a
            href="https://aclucrossword.org/"
            className={`inline-flex px-10 py-4 justify-center items-center gap-4 text-white font-black md:text-2xl sm:text-base rounded-md `}
        >
            ACLU CROSSWORD
        </a>
    )
